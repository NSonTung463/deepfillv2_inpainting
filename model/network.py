...
from model.network_module import *
...
class Coarse(nn.Module):
    def __init__(self, opt):
        ...
        self.coarse1 = nn.Sequential(
            # encoder
            GatedConv2d(4, 32, 5, 2, 2, activation=opt.activation, norm=opt.norm),
        ...
        self.coarse5 = nn.Sequential(
            GatedConv2d(64, 64, 3, 1, 4, dilation=4, activation=opt.activation, norm=opt.norm),
            GatedConv2d(64, 64, 3, 1, 4, dilation=4, activation=opt.activation, norm=opt.norm),
            GatedConv2d(64, 64, 3, 1, 4, dilation=4, activation=opt.activation, norm=opt.norm)
        )
        self.coarse6 = nn.Sequential(
            GatedConv2d(64, 64, 3, 1, 8, dilation=8, activation=opt.activation, norm=opt.norm),
            GatedConv2d(64, 64, 3, 1, 8, dilation=8, activation=opt.activation, norm=opt.norm),
            GatedConv2d(64, 64, 3, 1, 8, dilation=8, activation=opt.activation, norm=opt.norm)
        )
        self.coarse7 = nn.Sequential(
            GatedConv2d(64, 64, 3, 1, 16, dilation=16, activation=opt.activation, norm=opt.norm),
            GatedConv2d(64, 64, 3, 1, 16, dilation=16, activation=opt.activation, norm=opt.norm)
        )
        ...
        self.coarse9 = nn.Sequential(
            TransposeGatedConv2d(64, 64, 3, 1, 1, activation=opt.activation, norm=opt.norm),
